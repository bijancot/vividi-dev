                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-xs-12 col-md-6">
                                ...
                                <div class="checkbox">
                                    ...
                                    <button type="button" onclick="addFasilitas(event)" style="width: 100%"><span><i
                                                    class='fa fa-plus'></i>&nbsp;</span> Fasilitas
                                    </button>
                                </div>
                                <!--								<div class="checkbox">-->
                                <!--									<label>-->
                            ...
                            <div class="form-group col-xs-12">
                                <label>Masukan Harga Kamar Terendah</label><br>
                                <label>Rp.&nbsp&nbsp</label>
                                <input type="number" class="form-control" style="display: inline-block; width: 80%" name="harga" min="0" value="0">
                            </div>
                            <div class="form-group col-xs-12">
