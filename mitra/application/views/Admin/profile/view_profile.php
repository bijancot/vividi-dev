        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <!-- /.box-header -->
                    <div class="box-body">
                        <?php echo form_open(base_url('Admin/Profile/edit_profile')); ?>
                        ...
                        <div class="modal-footer">
                            <a href="<?= base_url('Admin/Profile/reset_pass'); ?>" class="btn btn-success" style="float: left">Reset Password</a>
