...
<!--      </form>-->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php }else{ ?>
            <li><a href="<?= base_url('home'); ?>"><i class="fa fa-circle-o"></i> Dashboard</a></li>
            <?php } ?>
        ...
        <?php } ?>
          ...
          <ul class="treeview-menu">
            ...
            <?php if($side == 'harga'){?><li class="active"><a href="#"><?php } else { ?><li><a href="<?= base_url('Properti/atur_harga'); ?>"><?php } ?>
