<div style="width: 760px;  margin:0 auto;">
	<div class="row">
		<div class="col-sm-6 col-md-8" style="background-color: #cccccc">
			...
			<span>E-Payment</span>
			<span style="margin-right: 15px; margin-top: 20px; color: #003580; font-family: arial; font-size: 20px; font-weight: bold;float: right">[booking_no]</span>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-6 col-md-8" style="background-color: #e6e6e6">
			...
			<span style="font-family: arial; color: #023f75; font-size: 20px; margin-left: 20px; margin-bottom: 10px; display:inline-block;"><b>[booking_valid_until]</b></span>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-6 col-md-8" style="background-color: #cccccc">
			...
			<span style="font-family: arial; margin-left: 20px; margin-top: 10px; display:inline-block; font-size: 22px"><b>[accommodation_name]</b></span><br>
			...
			<span style="font-family: arial; margin-bottom: 10px; margin-left: 20px; margin-top: 5px; display:inline-block; font-size: 15px">Check-Out : [booking_checkout_time]</span>
		</div>
	</div>

	<div class="row">
		<div class="col-sm-6 col-md-8" style="background-color: #F5F4F4">
			<span style="font-family: arial; margin-left: 20px; margin-top: 10px; display:inline-block; font-size: 22px"><b>Yth, [customer_first_name] [customer_last_name]</b></span><br>
	...
	<div class="row">
		<div class="col-sm-6 col-md-8" style="background-color: #e6e6e6">
			<span style="display:inline-block; font-family: arial; margin-bottom: 10px; margin-left: 20px; margin-top: 10px; font-size: 20px; color: red;">Total : [booking_total_price]</span>
		</div>
	</div>
	...
	<div class="row" style="margin-top: 10px">
		<div class="col-sm-6 col-md-8" style="background-color: #F5F4F4">
			...
			<span style="font-family: arial; font-size: 15px; margin-left: 20px; display: inline-block; margin-top: 2px">Lakukan konfirmasi pembayaran agar Kami dapat segera memproses voucher hotel ke alamat Email Kamu.</span><br>
			<span style="font-family: arial; font-size: 15px; margin-left: 20px; display: inline-block; margin-top: 2px; margin-bottom: 10px;">Caranya mudah, klik nomor rekening yang sudah Kamu bayar di atas.</span>
		</div>
	</div>
	...
	<div class="row" style="margin-top: 10px">
		<div class="col-sm-6 col-md-8" style="background-color: #F5F4F4">
			...
			<span style="font-family: arial; font-size: 15px; margin-left: 20px; display: inline-block; margin-top: 2px; margin-bottom: 10px;">Hubungi kami segera, dengan senang hati kami akan membantu 24/7 hari.</span><br>
		</div>
	</div>
	...
	<div class="row" style="margin-top: 10px">
		<div class="col-sm-6 col-md-8" style="background-color: #F5F4F4">
			<span style="font-family: arial; font-size: 15px; margin-left: 20px; display: inline-block; margin-top: 10px; margin-bottom: 10px;">Email ini ditujukan kepada [customer_first_name] [customer_last_name], karena telah melakukan
