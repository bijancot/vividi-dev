<div style="width: 800px; margin:0 auto;">
	<div class="row">
		<div class="col-sm-6 col-md-8" style="background-color: #cccccc">
			...
			<span>E-Payment</span>
			<span
				style="margin-right: 15px; margin-top: 20px; color: #003580; font-family: arial; font-size: 20px; font-weight: bold;float: right">[booking_no]</span>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-6 col-md-8" style="background-color: #e6e6e6">
			<span
				style="font-family: arial; font-size: 20px; margin-left: 20px; margin-top: 10px; display:inline-block;">Segera selesaikan pembayaran Kamu sebelum</span><br>
			<span
				style="font-family: arial; color: #023f75; font-size: 20px; margin-left: 20px; margin-bottom: 10px; display:inline-block;"><b>[booking_valid_until]</b></span>
		</div>
	</div>
