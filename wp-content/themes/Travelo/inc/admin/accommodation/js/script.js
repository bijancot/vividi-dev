...
jQuery(document).ready(function($) {
    ...
    $('.row-actions .delete a').click(function(){
        var r = confirm("Akan dihapus secara permanen. Apakah Kamu ingin menghapusnya?");
        if(r == false) {
            return false;
        }
    });
...
function manage_vacancy_validateForm() {
    ...
    if( '' == $('#accommodation_id').val() ) {
        alert('Mohon Pilih salah satu properti');
        return false;
    } else if( '' == $('#room_type_id').val() ) {
        alert('Mohon pilih salah satu tipe kamar');
        return false;
    }
