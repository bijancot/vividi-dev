...
class Trav_Tour_Booking_List_Table extends WP_List_Table {
    ...
    function get_columns() {
        $columns = array(
            ...
            'id'            => __( 'ID', 'trav' ),
            'customer_name' => __( 'Nama Pelanggan', 'trav' ),
            'tour_name'     => __( 'Nama Paket', 'trav' ),
            'schedule_type' => __( 'Tipe Tour', 'trav' ),
            'tour_date'     => __( 'Tanggal Tour', 'trav' ),
            'adults'        => __( 'Dewasa', 'trav' ),
            'kids'          => __( 'Anak', 'trav' ),
    ...
    function prepare_items() {
        ...
        $sql = sprintf( 'SELECT booking.*, tour.ID as tour_id, tour.post_title as tour_name FROM %1$s as booking
...
if ( ! function_exists( 'trav_tour_booking_add_menu_items' ) ) {
    function trav_tour_booking_add_menu_items() {
        $page = add_submenu_page( 'edit.php?post_type=tour', __('Pesanan Tour', 'trav'), __('Pesanan Tour', 'trav'), 'edit_accommodations', 'tour_bookings', 'trav_tour_booking_render_pages' );
...
if ( ! function_exists( 'trav_tour_booking_render_list_page' ) ) {
    function trav_tour_booking_render_list_page() {
        ...
        <div class="wrap">
            ...
            <h2><?php _e('Pesanan Tour', 'trav') ?> <a href="edit.php?post_type=tour&amp;page=tour_bookings&amp;action=add" class="add-new-h2"><?php _e('Tambah Baru', 'trav') ?></a></h2>
            ...
            <input type="text" id="tour_date" name="tour_date" placeholder="<?php _e('Filter Tanggal', 'trav') ?>" value="<?php if ( ! empty( $_REQUEST['tour_date'] ) ) echo esc_attr( $_REQUEST['tour_date'] ); ?>">
            <input type="text" id="booking_no" name="booking_no" placeholder="<?php _e('Filter Kode Booking', 'trav') ?>" value="<?php if ( ! empty( $_REQUEST['booking_no'] ) ) echo esc_attr( $_REQUEST['booking_no'] ); ?>">
            ...
            <a href="edit.php?post_type=tour&amp;page=tour_bookings" class="button-secondary"><?php _e('Lihat Semua', 'trav') ?></a>
...
if ( ! function_exists( 'trav_tour_booking_render_manage_page' ) ) {
    function trav_tour_booking_render_manage_page() {
        ...
        if ( 'add' == $_REQUEST['action'] ) {
            $page_title = __("Tambah Pesanan Baru", "trav");
        } elseif ( 'edit' == $_REQUEST['action'] ) {
            $page_title = __('Edit Pesanan Tour', 'trav') . '<a href="edit.php?post_type=tour&amp;page=tour_bookings&amp;action=add" class="add-new-h2">' . __('Tambah Baru', 'trav') . '</a>';
        ...
        <div class="wrap">
            ...
            <form method="post" onsubmit="return manage_booking_validateForm();">
                ...
                <div class="one-half">
                    <h3><?php _e('Rincian Pesanan', 'trav') ?></h3>
                    <table class="trav_admin_table trav_booking_manage_table">
                        ...
                        <tr>
                            <th><?php _e('Tanggal Tour', 'trav') ?></th>
                        ...
                        <?php if ( trav_is_multi_currency() ) { ?>
                            ...
                            <tr>
                                <th><?php _e('Total Konversi', 'trav') ?></th>
                ...
                <div class="one-half">
                    <h3><?php _e('Informasi Tamu', 'trav') ?></h3>
                    <table  class="trav_admin_table trav_booking_manage_table">
                        <tr>
                        ...
                        <tr>
                            <th><?php _e('Permintaan Tambahan', 'trav') ?></th>
                ...
                <a href="edit.php?post_type=tour&amp;page=tour_bookings" class="button-secondary"><?php _e('Batal', 'trav') ?></a>
...
if ( ! function_exists( 'trav_tour_booking_delete_action' ) ) {
    function trav_tour_booking_delete_action() {
        ...
        if ( ! current_user_can( 'manage_options' ) ) {
            $sql = sprintf( 'SELECT schedule.tour_id FROM %1$s as booking, %2$s as schedule WHERE booking.id = %3$d AND booking.ts_id=schedule.id' , TRAV_TOUR_BOOKINGS_TABLE, TRAV_TOUR_SCHEDULES_TABLE, $_REQUEST['booking_id'] );
