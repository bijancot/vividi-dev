...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        ...
        array(
            'id'       => 'currency_converter_key_type',
            'type'     => 'button_set',
            'title'    => __( 'Currency Converter Key Type', 'trav' ),
            'desc'     => __( 'Please check <a href="https://www.currencyconverterapi.com/pricing">here</a> to get currency converter api key.', 'trav' ),
            'options'  => array(
                'free' => __( 'Free key', 'trav' ),
                'premium' => __( 'Premium key', 'trav' )
            ),
            'default'  => 'free'
        ),
        array(
            'id'       => 'currency_converter_key',
            'type'     => 'text',
            'title'    => __( 'Currency Converter API Key', 'trav' ),
            'default'  => '',
        ),
    )
) );
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        ...
        array(
            ...
            'subtitle' => __('This sets the base page of your accommodation booking. Please add [accommodation_booking /] shortcode in the page content.', 'trav'),
            'options'  => $options_pages,
        ),
        array(
            ...
            'subtitle' => __('This sets the accommodation booking confirmation page. Please add [accommodation_booking_confirmation /] shortcode in the page content.', 'trav'),
            'options'  => $options_pages,
        ),
    ),
) );
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        ...
        array(
            ...
            'subtitle' => __('This sets the base page of your tour booking.  Please add [tour_booking] shortcode in the page content.', 'trav'),
            'options'  => $options_pages,
        ),
        array(
            ...
            'subtitle' => __('This sets the tour booking confirmation page. Please add [tour_booking_confirmation] shortcode in the page content.', 'trav'),
            'options'  => $options_pages,
        ),
        /*array(
            'id'       => 'tour_terms_page',
...
Redux::setSection( $opt_name, array(
	...
	'fields'     => array(
		...
		array(
			...
			'subtitle' => __('This sets the base page of your car booking. Please add [car_booking] shortcode in the page content.', 'trav'),
			'options'  => $options_pages,
		),
		array(
			...
			'subtitle' => __('This sets the car booking confirmation page. Please add [car_booking_confirmation] shortcode in the page content.', 'trav'),
			'options'  => $options_pages,
		),			
	),
) );
...
Redux::setSection( $opt_name, array(
	...
	'fields'     => array(
		...
		array(
			...
			'subtitle' => __('This sets the base page of your cruise booking. Please add [cruise_booking] shortcode in the page content.', 'trav'),
			'options'  => $options_pages,
		),
		array(
			...
			'subtitle' => __('This sets the cruise booking confirmation page. Please add [cruise_booking_confirmation] shortcode in the page content.', 'trav'),
			'options'  => $options_pages,
		),	
    ),
));
...
Redux::setSection( $opt_name, array(
    'title' => __( 'Flight', 'trav' ),
    'id'    => 'flight-settings',
) );

Redux::setSection( $opt_name, array(
    'title'      => __( 'Flight Main Settings', 'trav' ),
    'id'         => 'flight-main-settings',
    'subsection' => true,
    'fields'     => array(
        array(
            'id'       => 'disable_flight',
            'type'     => 'button_set',
            'title'    => __('Enable/Disable flight feature.', 'trav'),
            'default'  => 0,
            'options'  => array(
                '0' => __( 'Enable', 'trav' ),
                '1' => __( 'Disable', 'trav' )
        ...
        array(
            'id'       => 'flight_booking_page',
            'type'     => 'select',
            'required' => array( 'disable_flight', '=', '0' ),
            'title'    => __('Flight Booking Page', 'trav'),
            'subtitle' => __('This sets the base page of your flight booking. This page should have [flight_booking] shortcode.', 'trav'),
            'options'  => $options_pages,
        ),
        array(
            'id'       => 'flight_booking_confirmation_page',
            'type'     => 'select',
            'required' => array( 'disable_flight', '=', '0' ),
            'title'    => __('Flight Booking Confirmation Page', 'trav'),
            'subtitle' => __('This sets the flight booking confirmation page. This page should have [flight_booking_confirmation] shortcode.', 'trav'),
            'options'  => $options_pages,
        ),
    ),
) );
...
Redux::setSection( $opt_name, array(
    'title'      => __( 'Flight List Page Settings', 'trav' ),
    'id'         => 'flight-list-page-settings',
    'subsection' => true,
    'fields'     => array(
        array(
            'id'       => 'flight_enable_price_filter',
            'type'     => 'switch',
            'title'    => __('Enable Price Filter', 'trav'),
            'default'  => true,
        ),
        array(
            'id'        => "flight_price_filter_max",
            'type'      => 'text',
            'required'  => array( 'flight_enable_price_filter', '=', true ),
            'title'     => "Price Filter Max Value",
            'subtitle'  => __( "Set a max price value for price search filter", 'trav' ),
            'default'   => "200",
        ),
        array(
            'id'        => "flight_price_filter_step",
            'type'      => 'text',
            'required'  => array( 'flight_enable_price_filter', '=', true ),
            'title'     => "Price Filter Step",
            'subtitle'  => __( "Set a price step value for price search filter", 'trav' ),
        ...
        array(
            'id'       => 'flight_enable_flight_type_filter',
            'type'     => 'switch',
            'title'    => __('Enable Flight Type Filter', 'trav'),
            'default'  => true,
        ),        
        array(
            'id'       => 'flight_enable_air_line_filter',
            'type'     => 'switch',
            'title'    => __('Enable Air Line Filter', 'trav'),
            'default'  => true,
        ),        
        array(
            'id'       => 'flight_enable_flight_stop_filter',
            'type'     => 'switch',
            'title'    => __('Enable Flight Stop Filter', 'trav'),
            'default'  => true,
        ),
    ),
) );
...
// add-on compatibility
$flight_add_on_settings = apply_filters( 'trav_options_flight_addon_settings', array() );
if ( ! empty( $flight_add_on_settings ) ) {
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Flight Add-On Settings', 'trav' ),
        'id'         => 'flight-add-settings',
        'subsection' => true,
        'fields'     => array( $flight_add_on_settings )
    ) );
}

Redux::setSection( $opt_name, array(
    'title'      => __( 'Flight Email Settings', 'trav' ),
    'id'         => 'flight-email-settings',
    'subsection' => true,
    'fields'     => array(
        array(
            'id'        => 'flight_confirm_email_start',
            'type'      => 'section',
            'title'     => __( 'Customer Email Setting', 'trav' ),
            'indent'    => true,
        ),
        ...
        //     'title'     => __('Enable Icalendar', 'trav'),
        //     'subtitle'  => __('Send icalendar with booking confirmation email.', 'trav'),
        //     'id'        => 'flight_confirm_email_ical',
        //     'default'   => true,
        //     'type'      => 'switch',
        // ),
        array(
            'title'     => __('Booking Confirmation Email Subject', 'trav'),
            'subtitle'  => __( 'Flight booking confirmation email subject.', 'trav' ),
            'id'        => 'flight_confirm_email_subject',
            'default'   => 'Your booking at [flight_name]',
            'type'      => 'text',
        ),
        array(
            'title'     => __('Booking Confirmation Email Description', 'trav'),
            'subtitle'  => __( 'Flight booking confirmation email description.', 'trav' ),
            'id'        => 'flight_confirm_email_description',
            'default'   => file_get_contents( dirname( __FILE__ ) . '/templates/flight_confirm_email_description.htm' ),
            'type'      => 'editor'
        ),
        array(
            'id'        => 'flight_confirm_email_end',
            'type'      => 'section',
            'indent'    => false,
        ),
        array(
            'id'        => 'flight_admin_email_start',
            'type'      => 'section',
            'title'     => __( 'Admin Notification Setting', 'trav' ),
            'indent'    => true,
        ),
        array(
            'title'     => __('Administrator Notification', 'trav'),
            'subtitle'  => __('enable individual booked email notification to site administrator.', 'trav'),
            'id'        => 'flight_booked_notify_admin',
            'default'   => true,
            'type'      => 'switch'
        ),
        array(
            'title'     => __('Administrator Booking Notification Email Subject', 'trav'),
            'subtitle'  => __( 'Administrator Notification Email Subject for Flight Booking.', 'trav' ),
            'id'        => 'flight_admin_email_subject',
            'default'   => 'Received a booking at [flight_name]',
            'required'  => array( 'flight_booked_notify_admin', '=', '1' ),
            'type'      => 'text'
        ),
        array(
            'title'     => __('Administrator Booking Notification Email Description', 'trav'),
            'subtitle'  => __( 'Administrator Notification Email Description for Flight Booking.', 'trav' ),
            'id'        => 'flight_admin_email_description',
            'default'   => file_get_contents( dirname( __FILE__ ) . '/templates/flight_admin_email_description.htm' ),
            'required'  => array( 'flight_booked_notify_admin', '=', '1' ),
            'type'      => 'editor'
        ),
        array(
            'id'        => 'flight_admin_email_end',
            'type'      => 'section',
            'indent'    => false,
        ),
        array(
            'id'        => 'flight_bowner_email_start',
            'type'      => 'section',
            'title'     => __( 'Flight Onwer Notification Setting', 'trav' ),
            'indent'    => true,
        ),
        array(
            'title'     => __('Flight Owner Notification', 'trav'),
            'subtitle'  => __('Enable individual booked email notification to flight owner.', 'trav'),
            'id'        => 'flight_booked_notify_bowner',
            'default'   => true,
            'type'      => 'switch'
        ),
        array(
            'title'     => __('Flight Owner Notification Email Subject', 'trav'),
            'subtitle'  => __( 'Flight Owner Notification Email Subject for Flight Booking.', 'trav' ),
            'id'        => 'flight_bowner_email_subject',
            'default'   => 'Received a booking at [flight_name]',
            'required'  => array( 'flight_booked_notify_bowner', '=', '1' ),
            'type'      => 'text'
        ),
        array(
            'title'     => __('Flight Owner Notification Email Description', 'trav'),
            'subtitle'  => __( 'Flight Owner Notification Email Description for Flight Booking.', 'trav' ),
            'id'        => 'flight_bowner_email_description',
            'default'   => file_get_contents( dirname( __FILE__ ) . '/templates/flight_bowner_email_description.htm' ),
            'required'  => array( 'flight_booked_notify_bowner', '=', '1' ),
            'type'      => 'editor'
        ),
        array(
            'id'        => 'flight_bowner_email_end',
            'type'      => 'section',
            'indent'    => false,
        ),
    ),
