...
if ( ! function_exists( 'trav_cabin_org_id' ) ) {
	function trav_cabin_org_id($id) {
		return trav_get_default_language_post_id( $id, 'cabin_type' );
	}
}
...
if ( ! function_exists( 'trav_cabin_clang_id' ) ) {
	function trav_cabin_clang_id($id) {
		return trav_get_current_language_post_id( $id, 'cabin_type' );
	}
}
...
/*
 * get sibling flight id in original language
 */
if ( ! function_exists( 'trav_flight_org_id' ) ) {
	function trav_flight_org_id($id) {
		return trav_get_default_language_post_id( $id, 'flight' );
	}
}

/*
 * get sibling flight id in current language
 */
if ( ! function_exists( 'trav_flight_clang_id' ) ) {
	function trav_flight_clang_id($id) {
		return trav_get_current_language_post_id( $id, 'flight' );
	}
}
 ...
 * get default language
 */
if ( ! function_exists( 'trav_switch_language' ) ) {
	function trav_switch_language( $lang ) {
