      ...
      menu  : [
        ...
        { text: 'Pages & Lists',
          menu : [
             ...
             { text : 'Car Booking Page', onclick: function() {editor.insertContent('[car_booking]');} },
             { text : 'Car Booking Confirmation Page', onclick: function() {editor.insertContent('[car_booking_confirmation]');} },
             { text : 'Cruise Booking Page', onclick: function() {editor.insertContent('[cruise_booking]');} },
             { text : 'Cruise Booking Confirmation Page', onclick: function() {editor.insertContent('[cruise_booking_confirmation]');} },
             { text : 'Flight Booking Page', onclick: function() {editor.insertContent('[flight_booking]');} },
             { text : 'Flight Booking Confirmation Page', onclick: function() {editor.insertContent('[flight_booking_confirmation]');} },
          ]
        }
      ]
