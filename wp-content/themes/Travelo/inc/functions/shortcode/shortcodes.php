...
class TravShortcodes {
	...
	* **************************************************************** */
	function shortcode_search_form( $atts, $content = null ) {
									...
									<div class="col-xs-6">
										<div class="selector">
											<select name="adults" class="full-width">
												<option value="" disabled selected><?php echo __( 'Dewasa', 'trav' ) ?></option>
												<?php
		...
		<?php } elseif ( $post_type == 'cruise' && empty( $content ) ) { ?>
				...
				<div class="search-box">
					<form role="search" method="get" class="cruise-searchform" action="<?php echo esc_url( get_post_type_archive_link( 'cruise' ) ); ?>">
						...
						<div class="row">
							...
							<div class="form-group col-sm-6 col-md-3">
								<div class="row">
									<?php $cruise_types = get_terms( 'cruise_type', array( 'hide_empty' => false ) ); ?>
									...
									<?php $cruise_lines = get_terms( 'cruise_line', array( 'hide_empty' => false ) ); ?>
			...
			<?php endif; ?>
		<?php } elseif ( $post_type == 'flight' && empty( $content ) ) { ?>
			<?php if ( $style == 'style2' ) : ?>
				<div class="search-box">
					<form role="search" method="get" class="flight-searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
						<input type="hidden" name="post_type" value="flight">
						<div class="row">
							<div class="form-group col-sm-6 col-md-3">
								<div class="selector">
									<select name="location_from" class="full-width">
										<option value=""><?php _e( 'From', 'trav' ); ?></option>
										<?php
							...
							<div class="form-group col-sm-6 col-md-3">
								<div class="selector">
									<select name="location_to" class="full-width">
										<option value=""><?php _e( 'To', 'trav' ); ?></option>
										<?php
											$flight_locations = get_terms( 'flight_location', array( 'hide_empty' => false, ) );
											foreach ( $flight_locations as $flight_location ) {
												echo '<option value="' . esc_attr( $flight_location->term_id ) . '" ' . ' >' . esc_html( $flight_location->name ) . '</option>';
							...
							<div class="form-group col-sm-6 col-md-2">
								<div class="row search-when">
									<div class="datepicker-wrap from-today">
										<input name="flight_date" type="text" class="input-text full-width" placeholder="<?php echo trav_get_date_format('html'); ?>" value="" />
									</div>
								</div>
							</div>
									...
									<select name="adults" class="full-width">
										<?php
											for ( $i = 1; $i <= $search_max_flighters; $i++ ) {
												echo '<option value="' . esc_attr( $i ) . '" ' . '>' . esc_html( $i ) . ' ' . ( ( $i == 1 ) ? __( 'Guest', 'trav' ) : __( 'Guests', 'trav' ) ) . '</option>';
											}
										?>
									</select>
								</div>
								...
								<div class="row">
									<div class="col-md-6">
										...
										<div class="form-group row">
											<div class="col-xs-6">
												<label><?php _e( 'Leaving From', 'trav' ); ?></label>
												<div class="selector">
													<select name="location_from" class="full-width">
														<?php
															$flight_locations = get_terms( 'flight_location', array( 'hide_empty' => false, ) );
											...
											<div class="col-xs-6">
												<label><?php _e( 'Going To', 'trav' ); ?></label>
												<div class="selector">
													<select name="location_to" class="full-width">
														<?php
															foreach ( $flight_locations as $flight_location ) {
									...
									<div class="col-xs-6 col-md-2">
										...
										<div class="form-group">
											<label><?php _e( 'Departure Date', 'trav' ); ?></label>
											<div class="datepicker-wrap from-today">
												<input name="flight_date" type="text" class="input-text full-width" placeholder="<?php echo trav_get_date_format('html'); ?>" value="" />
											</div>
										</div>
									...
									<div class="col-xs-6 col-md-2">
										<h4 class="title"><?php _e( 'Who', 'trav' ); ?></h4>
										<div class="form-group">
											<label><?php _e( 'Peoples', 'trav' ); ?></label>
											<div class="selector">
												<select name="adults" class="full-width">
													<?php
														for ( $i = 1; $i <= $search_max_flighters; $i++ ) {
									...
									<div class="form-group col-md-2 fixheight">
										<label class="hidden-xs">&nbsp;</label>
										<button class="icon-check full-width"><?php _e( 'SEARCH NOW', 'trav' ); ?></button>
									</div>
								</div>
							</form>
						</div>
			...
			<div class="search-box">
				<?php if ( count( $enabled_features ) > 1 ) : ?>
					<ul class="search-tabs clearfix">
						<?php if ( in_array( 'acc', $enabled_features ) ) : ?>
							<li <?php if ( $enabled_features[0] == 'acc' ) echo 'class="active"' ?> ><a href="#hotels-tab" data-toggle="tab"><i class="soap-icon-hotel"></i> <span><?php _e( 'HOTEL', 'trav' ) ?></span></a></li>
						<?php endif; ?>
						<?php if ( in_array( 'tour', $enabled_features ) ) : ?>
							<li <?php if ( $enabled_features[0] == 'tour' ) echo 'class="active"' ?> ><a href="#tours-tab" data-toggle="tab"><i class="soap-icon-beach"></i> <span><?php _e( 'PAKET TOUR', 'trav' ) ?></span></a></li>
						<?php endif; ?>
						<?php if ( in_array( 'car', $enabled_features ) ) : ?>
							<li <?php if ( $enabled_features[0] == 'car' ) echo 'class="active"' ?> ><a href="#cars-tab" data-toggle="tab"><i class="soap-icon-car"></i> <span><?php _e( 'SEWA BUS & MOBIL', 'trav' ) ?></span></a></li>
						<?php endif; ?>
					...
					<ul id="mobile-search-tabs" class="search-tabs clearfix">
						<?php if ( in_array( 'acc', $enabled_features ) ) : ?>
							<li <?php if ( $enabled_features[0] == 'acc' ) echo 'class="active"' ?> ><a href="#hotels-tab" data-toggle="tab"><?php _e( 'HOTEL', 'trav' ) ?></a></li>
						<?php endif; ?>
						<?php if ( in_array( 'tour', $enabled_features ) ) : ?>
							<li <?php if ( $enabled_features[0] == 'tour' ) echo 'class="active"' ?> ><a href="#tours-tab" data-toggle="tab"><?php _e( 'PAKET TOUR', 'trav' ) ?></a></li>
						<?php endif; ?>
						<?php if ( in_array( 'car', $enabled_features ) ) : ?>
							<li <?php if ( $enabled_features[0] == 'car' ) echo 'class="active"' ?> ><a href="#cars-tab" data-toggle="tab"><?php _e( 'SEWA BUS & MOBIL', 'trav' ) ?></a></li>
						<?php endif; ?>
						<?php if ( in_array( 'cruise', $enabled_features ) ) : ?>
				...
				<?php if ( $style == 'style2' || $style == 'style4' ) { ?>
					<div class="search-tab-content">
						<?php if ( in_array( 'acc', $enabled_features ) ) : ?>
							...
							<form role="search" method="get" class="acc-searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
								...
								<div class="row">
									...
									<div class="form-group col-sm-6 col-md-4">
										<div class="row search-when" data-error-message1="<?php echo __( 'Tanggal Check In kamu setelah tanggal Check Out, Mohon periksa kembali.' , 'trav') ?>" data-error-message2="<?php echo __( 'Silakan pilih tanggal saat ini atau di masa mendatang untuk check-in dan check-out.' , 'trav') ?>">
											<div class="col-xs-6">
												<div class="datepicker-wrap from-today">
									...
									<div class="form-group col-md-5">
										<div class="row">
													...
													<select name="rooms" class="full-width">
														<?php
															...
															for ( $i = 1; $i <= $search_max_rooms; $i++ ) {
																$selected = '';
																if ( $i == $rooms ) $selected = 'selected';
																echo '<option value="' . esc_attr( $i ) . '" ' . $selected . '>' . esc_html( $i ) . ' ' . (( $i == 1 ) ? __( 'Kamar', 'trav' ) : __( 'Kamar', 'trav' )) . '</option>';
															}
														?>
													</select>
												</div>
													...
													<select name="adults" class="full-width">
														<?php
															...
															for ( $i = 1; $i <= $search_max_adults; $i++ ) {
																$selected = '';
																if ( $i == $adults ) $selected = 'selected';
																echo '<option value="' . esc_attr( $i ) . '" ' . $selected . '>' . esc_html( $i ) . ' ' . ( ( $i == 1 ) ? __( 'Tamu', 'trav' ) : __( 'Tamu', 'trav' ) ) . '</option>';
															}
														?>
													</select>
												</div>
											...
											<div class="col-xs-4">
												<button type="submit" class="full-width"><?php _e( 'CARI', 'trav') ?></button>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="form-group col-sm-8 col-md-4">
										<div class="row">
											<div class="col-xs-6">
												<div class="datepicker-wrap from-today">
													<input name="date_from" type="text" class="input-text full-width" placeholder="<?php _e( 'Berangkat', 'trav' ); ?>" />
												</div>
											</div>
											<div class="col-xs-6">
												<div class="datepicker-wrap from-today">
													<input name="date_to" type="text" class="input-text full-width" placeholder="<?php _e( 'Pulang', 'trav' ) ?>" />
												</div>
											</div>
										</div>
									</div>
									<div class="form-group col-sm-6 col-md-3">
										...
										<div class="row">
											...
											<?php endif; ?>
											<div class="col-xs-6">
												<input type="text" name="max_price" class="input-text full-width" placeholder="<?php echo sprintf( __( 'Max Harga (%s)', 'trav'), $def_currency ) ?>" />
											</div>
										</div>
									</div>
									<div class="form-group col-sm-6 col-md-2">
						...
						<?php if ( in_array( 'car', $enabled_features ) ) : ?>
							...
							<form role="search" method="get" class="car-searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
								...
								<div class="row">
									...
									<div class="form-group col-sm-6 col-md-4">
										<div class="row search-when" data-error-message1="<?php echo __( 'Tanggal penjemputan kamu setelah tanggal selesai, mohon periksa kembali.' , 'trav') ?>" data-error-message2="<?php echo __( 'Silakan pilih tanggal saat ini atau di masa mendatang untuk Jemput dan Selesai.' , 'trav') ?>">
											<div class="col-xs-6">
												<div class="datepicker-wrap from-today">
													<input name="date_from" type="text" class="input-text full-width" placeholder="<?php _e( 'Jemput', 'trav' ) ?>" />
												</div>
											</div>
											<div class="col-xs-6">
												<div class="datepicker-wrap from-today">
													<input name="date_to" type="text" class="input-text full-width" placeholder="<?php _e( 'Selesai', 'trav' ) ?>" />
												</div>
											</div>
										</div>
									</div>
									...
									<div class="form-group col-sm-6 col-md-3">
										<div class="row">
													...
													<select name="passengers" class="full-width">
														<?php
															...
															for ( $i = 1; $i <= $search_max_passengers; $i++ ) {
																$selected = '';
																if ( $i == $passengers ) $selected = 'selected';
																echo '<option value="' . esc_attr( $i ) . '" ' . $selected . '>' . esc_html( $i ) . ' ' . __('Tamu', 'trav') .  '</option>';
															}
														?>
													</select>
												</div>
											...
											<div class="col-xs-7">
	                                            <div class="selector">
	                                                <select class="full-width" name="car_types">
	                                                	<option value=""><?php _e( 'Tipe Kendaraan','trav' ); ?></option>
	                                                	<?php
	                                                	$all_car_types = get_terms( 'car_type', array('hide_empty' => 0) );
														foreach ( $all_car_types as $each_car_type ) {
															echo '<option value="' . esc_attr( $each_car_type->term_id ) . '">' . esc_html( $each_car_type->name ) . '</option>';
									...
									<div class="form-group col-sm-6 col-md-2">
										<button type="submit" class="full-width icon-check animated" data-animation-type="bounce" data-animation-duration="1"><?php _e( 'CARI', 'trav') ?></button>
									</div>
								</div>
							</form>
							<?php if ( count( $enabled_features ) > 1 ) : ?>
						...
						<?php if ( in_array( 'flight', $enabled_features ) ) : ?>
							<?php if ( count( $enabled_features ) > 1 ) : ?>
								<div class="tab-pane fade<?php if ( $enabled_features[0] == 'flight' ) echo ' active in' ?>" id="flights-tab">
							<?php endif; ?>
							<h4 class="title"><?php _e( 'Where do you want to go?' ,'trav' ) ?></h4>
							<form role="search" method="get" class="flight-searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
								<input type="hidden" name="post_type" value="flight">
					...
					<div class="search-tab-content">
						...
						<?php if ( in_array( 'flight', $enabled_features  ) ) : ?>
							...
							<form role="search" method="get" class="flight-searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
								<input type="hidden" name="post_type" value="flight">
								<div class="title-container">
									<h2 class="search-title"><?php _e( 'Search and Book flights', 'trav' ) ?></h2>
									<p><?php _e( "We're bringing you a new level of comfort.", 'trav' ) ?></p>
									<i class="soap-icon-plane"></i>
								</div>
								<div class="search-content">
									<h5 class="title"><?php _e( 'Leaving From','trav' ); ?></h5>
									<div class="selector">
                                        <select name="location_from" class="full-width">
                                        	<option value=""><?php _e( 'From', 'trav' ); ?></option>
                                            <?php
									...
									<hr>
									<h5 class="title"><?php _e( 'Going To','trav' ); ?></h5>
									<div class="selector">
										<select name="location_to" class="full-width">
                                        	<option value=""><?php _e( 'To', 'trav' ); ?></option>
                                            <?php
		                    ...
		                    if ( ! empty( $acc_pos ) ) { 
		                     ...
		                     ?>
		                        '<?php echo $acc_id; ?>' :  [{
		                            ...
		                            url_point: '<?php echo esc_url( get_permalink( $acc_id ) ); ?>'
		                        }],
		                    <?php
		                    }
		                } ?>
	...
	* **************************************************************** */
	...
	/* ***************************************************************
	* **************** Flight Booking Page Shortcode **********
	* **************************************************************** */
	function shortcode_flight_booking( $atts, $content = null ) {
		ob_start();
		trav_get_template( 'flight-booking.php', '/templates/flight' );
		$output = ob_get_contents();
		ob_end_clean();
		return $output;
	}
	...
	/* ***************************************************************
	* ******* Flight Booking Confirmation Page Shortcode ******
	* **************************************************************** */
	function shortcode_flight_booking_confirmation( $atts, $content = null ) {
		ob_start();
		trav_get_template( 'flight-booking-confirmation.php', '/templates/flight' );
		$output = ob_get_contents();
		ob_end_clean();
		return $output;
	}
