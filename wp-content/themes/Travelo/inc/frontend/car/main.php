...
require_once( TRAV_INC_DIR . '/frontend/car/functions.php');
require_once( TRAV_INC_DIR . '/frontend/car/templates.php');
require_once( TRAV_INC_DIR . '/frontend/car/ajax.php');
