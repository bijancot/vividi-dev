...
<?php
    ...
    if ( ! empty( $my_account_page ) ) {
        $mobile_mini_menu .= '<li><a href="' . esc_url( $my_account_page ) . '"' . ( ( $my_account_page == '#travelo-login' ) ? ' class="soap-popupbox"' : '') . '>' . esc_html__( 'CEK ORDER', 'trav' ) . '</a></li>';
    }

    if ( isset( $trav_options['woo_show_mini_cart'] ) && $trav_options['woo_show_mini_cart'] ) {
        $mobile_mini_menu .= '<li>
        <div class="mini-cart">
    ...
    if ( is_user_logged_in() ) {
        ...
        if ( get_option('users_can_register') ) {
            $mobile_mini_menu .= '<li><a href="' . $signup_url . '"' . (( $signup_url == '#travelo-signup' )?' class="soap-popupbox"':'') . '>' . __( 'DAFTAR', 'trav' ) . '</a></li>';
        }
    }
    ...
    if ( get_option('users_can_register') ) {
        ...
        <div id="travelo-signup" class="travelo-modal-box travelo-box">
            ...
            <form name="registerform" action="<?php echo esc_url( wp_registration_url() )?>" method="post">
                ...
                <div class="form-group">
                    <input type="email" name="user_email" class="input-text full-width" placeholder="<?php _e( 'alamat email', 'trav' ) ?>">
                </div>
                <div class="form-group">
