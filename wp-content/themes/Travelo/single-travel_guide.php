					...
					<div id="main" class="col-md-9">
						<div class="tab-container style1" id="travel-guide">
							...
							<?php
								...
								if ( ! empty( $g_info ) ) {
									echo '<li' . $active_class . '><a href="#travel-guide-info" data-toggle="tab">' . __( 'Semua Info', 'trav' ) . '</a></li>';
									$active_class = '';
								}
								if ( ! empty( $sports ) ) {
									echo '<li' . $active_class . '><a href="#travel-guide-sports" data-toggle="tab">' . __( 'Olahraga', 'trav' ) . '</a></li>';
									$active_class = '';
								}
								if ( ! empty( $culture ) ) {
									echo '<li' . $active_class . '><a href="#travel-guide-culture-history" data-toggle="tab">' . __( 'Budaya & Sejarah', 'trav' ) . '</a></li>';
									$active_class = '';
								}
								if ( ! empty( $nightlife ) ) {
									echo '<li' . $active_class . '><a href="#travel-guide-nightlife" data-toggle="tab">' . __( 'Wisata Malam', 'trav' ) . '</a></li>';
									$active_class = '';
								}
								if ( ! empty( $acc_list ) ) {
									echo '<li' . $active_class . '><a href="#travel-guide-hotels" data-toggle="tab">' . __( 'Penginapan', 'trav' ) . '</a></li>';
									$active_class = '';
								}
								if ( ! empty( $tour_list ) ) {
									echo '<li' . $active_class . '><a href="#travel-guide-tours" data-toggle="tab">' . __( 'Paket Wisata', 'trav' ) . '</a></li>';
									$active_class = '';
								}
							?>
							</ul>
