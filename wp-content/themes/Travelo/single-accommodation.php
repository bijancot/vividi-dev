                    ...
                    <div id="main" class="col-sm-8 col-md-9">
                        <div class="tab-container style1" id="hotel-main-content">
                            <ul class="tabs">
                                ...
                                <?php if ( ! empty( $gallery_imgs ) && $show_gallery ) { ?>
                                    <li><a data-toggle="tab" href="#photos-tab"><?php echo __( 'Gallery', 'trav' ) ?></a></li>
                                <?php } ?>

                                <?php if ( ! empty( $map ) ) { ?>
                                    <?php if ( $show_map ) { ?>
                                        <li><a data-toggle="tab" href="#map-tab"><?php echo __( 'Peta', 'trav' ) ?></a></li>
                                    <?php } ?>
                                    <?php if ( $show_street_view ) { ?>
                                        <li><a data-toggle="tab" href="#steet-view-tab"><?php echo __( 'Sekitar Lokasi', 'trav' ) ?></a></li>
                                    <?php } ?>
                                <?php } ?>

                                <?php if ( $show_calendar ) { ?>
                                    <li><a data-toggle="tab" href="#calendar-tab"><?php echo __( 'Kalender', 'trav' ) ?></a></li>
                                <?php } ?>

                                <?php if ( ! empty( $acc_meta['trav_accommodation_tg'] ) ) { ?>
                                    <li class="pull-right"><a class="button btn-small yellow-bg white-color" href="<?php echo esc_url( get_permalink( $acc_meta['trav_accommodation_tg'][0] ) ); ?>"><?php _e( 'IDE WISATA', 'trav' ) ?></a></li>
                                <?php } ?>
                                        ...
                                        <div class="photo-gallery flexslider style1" data-animation="slide" data-sync="#photos-tab .image-carousel">
                                            <ul class="slides">
                                                <?php foreach ( $gallery_imgs as $gallery_img ) {
                                                    echo '<li>' . wp_get_attachment_image( $gallery_img, 'slider-gallery' ) . '</li>';
                                                } ?>
                                            </ul>
                                        </div>
                                    ...
                                    <div id="calendar-tab" class="tab-pane fade">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-4 no-lpadding">
                                                <label><?php _e( 'PILIH BULAN', 'trav' );?></label>
                                                <div class="selector">
                                            ...
                                            <?php if ( ! empty( $room_types ) ) { ?>
                                                    <div class="col-sm-6 col-md-4 no-lpadding">
                                                        <label><?php _e( 'PILIH TIPE KAMAR', 'trav' );?></label>
                                                        <div class="selector">
                                                            <select class="full-width" id="select-room-type">
                                                                <option value=""><?php _e( 'Semua Tipe Kamar', 'trav' ); ?></option>
                                                                <?php
                                            ...
                                            <?php if ( ! empty( $calendar_desc ) ) { ?>
                                                <div class="col-sm-8">
                                                    ...
                                                    <div class="calendar-legend">
                                                        <label class="available"><?php echo __( 'Tersedia', 'trav' ) ?></label>
                                                        <label class="unavailable"><?php echo __( 'Tidak Tersedia', 'trav' ) ?></label>
                                                        <label class="past"><?php echo __( 'Lewat Tanggal', 'trav' ) ?></label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <p class="description">
                        ...
                        <div id="hotel-features" class="tab-container">
                            <ul class="tabs">
                                ...
                                <li<?php echo ( $def_tab == 'desc' ) ? ' class="active"' : '' ?>><a href="#hotel-description" data-toggle="tab"><?php _e( 'Deskripsi','trav' ); ?></a></li>
                                <li<?php echo ( $def_tab == 'rooms' ) ? ' class="active"' : '' ?>><a href="#hotel-availability" data-toggle="tab"><?php _e( 'Cek Ketersediaan','trav' ); ?></a></li>
                                <li<?php echo ( $def_tab == 'amenity' ) ? ' class="active"' : '' ?>><a href="#hotel-amenities" data-toggle="tab"><?php _e( 'Fasilitas','trav' ); ?></a></li>
                                <li><a href="#hotel-reviews" data-toggle="tab"><?php _e( 'Ulasan','trav' ); ?></a></li>
                                <?php if ( ! empty( $acc_meta['trav_accommodation_faq'] ) ) : ?>
                                    <li><a href="#hotel-faqs" data-toggle="tab"><?php _e( 'Tanya-Jawab','trav' ); ?></a></li>
                                <?php endif ?>
                                <?php if ( ! empty( $things_to_do ) ) : ?>
                                    <li><a href="#hotel-things-todo" data-toggle="tab"><?php _e( 'Ide Kegiatan','trav' ); ?></a></li>
                                <?php endif; ?>
                                <li><a href="#hotel-write-review" data-toggle="tab"><?php _e( 'Tulis Ulasan','trav' ); ?></a></li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane fade<?php echo ( $def_tab == 'rooms' ) ? ' in active' : '' ?>" id="hotel-availability">
                                    <form id="check_availability_form" method="post">
                                        ...
                                        <div class="update-search clearfix">
                                            <div class="alert alert-error" style="display:none;"><span class="message"><?php _e( 'Mohon masukan tanggal Check In.','trav' ); ?></span><span class="close"></span></div>
                                            <div class="col-md-5">
                                                <h4 class="title"><?php _e( '','trav' ); ?></h4>
                                                <div class="row">
                                                    <div class="col-xs-6">
                                    ...
                                    <h2><?php echo __( 'KETERSEDIAAN KAMAR', 'trav' ) ?></h2>
                                    <div class="room-list listing-style3 hotel">
                                        ...
                                        <?php 
                                            ...
                                            if ( ! empty( $room_types ) ) {
                                                ...
                                                echo __( 'Kamar tidak ditemukan', 'trav' );
                                            }
                                        ?>
                                ...
                                <div class="tab-pane fade<?php echo ( $def_tab == 'desc' ) ? ' in active' : '' ?>" id="hotel-description">
                                        ...
                                        <div class="col-sm-4 features table-cell">
                                            ...
                                            <?php
                                                ...
                                                if ( ! empty ( $accommodation_type ) ) {
                                                    echo sprintf( $tr, __( 'Tipe Properti', 'trav' ), esc_attr( $accommodation_type[0]->name ) );
                                                }

                                                $detail_fields = array( 
                                                    'star_rating' => array( 'label' => __('Kelas Hotel', 'trav'), 'pre' => '', 'sur' => ' ' . __( 'Bintang', 'trav') ),
                                                    ...
                                                    'neighborhood' => array( 'label' => __('Lingkungan', 'trav'), 'pre' => '', 'sur' => '' ),
                                                    ...
                                                    'minimum_stay' => array( 'label' => __('Min. Menginap', 'trav'), 'pre' => '', 'sur' => ' ' . __( 'Malam', 'trav') ),
                                    ...
                                    <div class="long-description">
                                        ...
                                        <div class="box policies-box">
                                            <h2><?php printf( __( 'KEBIJAKAN %s', 'trav' ), wp_kses_post( get_the_title( $acc_id ) ) ) ?></h2>
                                            <?php
                                                $tr = '<div class="row"><div class="col-md-2"><label>%s:</label></div><div class="col-md-10">%s</div></div>';
                                                ...
                                                $detail_fields = array( 
                                                    ...
                                                    'extra_beds_detail' => array( 'label' => __('Anak & Extra Bed', 'trav'), 'pre' => '', 'sur' => '' ),
                                                    'cards' => array( 'label' => __('Kartu Kredit', 'trav'), 'pre' => '', 'sur' => '' ),
                                                    'pets' => array( 'label' => __('Binatang Peliharaan', 'trav'), 'pre' => '', 'sur' => '' ),
                                                    'other_policies' => array( 'label' => __('Kebijakan Lainnya', 'trav'), 'pre' => '', 'sur' => '' ),
                                                );
                                ...
                                <div class="tab-pane fade<?php echo ( $def_tab == 'amenity' ) ? ' in active' : '' ?>" id="hotel-amenities">
                                    <h2><?php echo __('FASILITAS ', 'trav'); the_title();?></h2>
                                    <p>
                                        <?php
                                ...
                                <div class="tab-pane fade" id="hotel-reviews">
                                    <div class="intro table-wrapper full-width hidden-table-sms">
                                        <div class="rating table-cell col-sm-4">
                                            ...
                                            <a href="#" class="goto-writereview-pane button green btn-small full-width"><?php echo esc_html__( 'TULIS ULASAN', 'trav' ) ?></a>
                                        </div>
                                                ...
                                                <ul class="clearfix">
                                                    <?php
                                                        $review_factors = array(
                                                                'cln' => __( 'Kebersihan', 'trav' ),
                                                                'cft' => __( 'Kenyamanan', 'trav' ),
                                                                'loc' => __( 'Lokasi', 'trav' ),
                                                                'fac' => __( 'Fasilitas', 'trav' ),
                                                                'stf' => __( 'Staff', 'trav' ),
                                                                'vfm' => __( 'Harga', 'trav' ),
                                                            );
                                                        $i = 0;
                                    ...
                                    <div class="guest-reviews">
                                        <h2><?php echo __('Ulasan Tamu', 'trav') . ' <small>('; echo esc_html( trav_get_review_count(  trav_acc_org_id( $acc_id ) ) . ' ' .  __('Ulasan', 'trav') . ')' ); ?></small></h2>
                                        <?php
                                            $per_page = 10;
                                    ...
                                    <?php if ( $review_count >= $per_page ) { ?>
                                        <a href="#" class="more-review"><button class="silver full-width btn-large"><?php echo __( 'ULASAN LAINNYA', 'trav' ) ?></button></a>
                                    <?php } ?>
                                </div>
                                <?php if ( ! empty( $acc_meta['trav_accommodation_faq'] ) ) : ?>
                                ...
                                <?php if ( ! empty( $things_to_do ) ) : ?>
                                    <div class="tab-pane fade" id="hotel-things-todo">
                                        <h2><?php _e('Ide Kegiatan', 'trav');?></h2>
                                            ...
                                            <?php foreach( $things_to_do as $ttd_id ) { ?>
                                                <article class="box">
                                                    ...
                                                    <div class="details">
                                                        ...
                                                        ?></p>
                                                        <a class="button" title="<?php echo __( 'LAINNYA', 'trav' ) ?>" href="<?php echo esc_url( get_permalink( $ttd_id ) ); ?>"><?php echo __( 'LAINNYA', 'trav' ) ?></a>
                                                    </div>
                                                </article>
                                            <?php } ?>
                                        </div>
                                    ...
                                    <div class="main-rating table-wrapper full-width hidden-table-sms intro">
                                        <article class="image-box box hotel listing-style1 table-cell col-sm-4 photo">
                                            ...
                                            <div class="details">
                                                ...
                                                <div class="feedback">
                                                    <div title="<?php echo esc_attr( $acc_review . ' ' . __( 'Bintang', 'trav') );?>" class="five-stars-container" data-toggle="tooltip" data-placement="bottom"><span class="five-stars" style="width: <?php echo esc_html( $acc_review / 5 * 100 );?>%;"></span></div>
                                                    <span class="review"><?php echo esc_html( trav_get_review_count( $acc_id ) ); echo ' ' . __( 'Ulasan', 'trav' ) ?></span>
                                                </div>
                                            </div>
                                        </article>
                                        <div class="table-cell col-sm-8 no-rpadding">
                                            <div class="overall-rating">
                                                <h4><?php _e( 'Peringkat keseluruhan Kamu untuk properti ini', 'trav');?></h4>
                                    ...
                                    <form class="review-form" id="review-form" method="post">
                                        ...
                                        <div class="row clearer">
                                            <div class="form-group col-md-5 no-padding">
                                                <h4><?php _e( 'Kode Booking', 'trav'); ?></h4>
                                                <input type="text" name="booking_no" class="input-text full-width validation-field" value="<?php if ( is_array( $booking_data ) && isset( $booking_data['booking_no'] ) ) echo esc_attr( $booking_data['booking_no'] ); ?>" data-error-message="<?php _e( 'Masukan Kode Booking', 'trav' ); ?>" placeholder="<?php _e( 'Masukan Kode Booking Kamu', 'trav' ); ?>" />
                                            </div>
                                            <div class="form-group col-md-5 col-md-offset-1 no-padding">
                                                <h4><?php _e( 'PIN', 'trav'); ?></h4>
                                                <input type="text" name="pin_code" class="input-text full-width validation-field" value="<?php if ( is_array( $booking_data ) && isset( $booking_data['pin_code'] ) ) echo esc_attr( $booking_data['pin_code'] ); ?>" data-error-message="<?php _e( 'Masukan PIN Pemesanan Kamu', 'trav' ); ?>" placeholder="<?php _e( 'Masukan PIN', 'trav' ); ?>" />
                                            </div>
                                        </div>

                                         <div class="form-group col-md-5 no-float no-padding">
                                            <h4><?php _e( 'Judul Ulasan Kamu', 'trav'); ?></h4>
                                            <input type="text" name="review_title" class="input-text full-width validation-field" value="<?php if ( is_array( $review_data ) && isset( $review_data['review_title'] ) ) echo esc_attr( $review_data['review_title'] ); ?>" data-error-message="<?php _e( 'Masukan Judul Ulasan', 'trav' ); ?>" placeholder="<?php _e( 'Masukan Judul Ulasan Kamu', 'trav' ); ?>" />
                                        </div>
                                        <div class="form-group">
                                            <h4><?php _e( 'Ulasan Kamu', 'trav'); ?></h4>
                                            <textarea name="review_text" class="input-text full-width validation-field" data-error-message="<?php _e( 'Tulis ulasan kamu', 'trav' ); ?>" placeholder="<?php _e( 'Tulis Ulasan kamu disini', 'trav' ); ?>" rows="5"><?php if ( is_array( $review_data ) && isset( $review_data['review_text'] ) ) echo esc_textarea( $review_data['review_text'] ); ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <h4><?php _e( 'Tipe Perjalanan Kamu?', 'trav'); ?></h4>
                                            <ul class="sort-trip clearfix">
                                                <?php
                                                    $trip_types = array(
                                                            'businessbag' => __( 'Bisnis', 'trav' ),
                                                            'couples' => __( 'Pasangan', 'trav' ),
                                                            'family' => __( 'Keluarga', 'trav' ),
                                                            'friends' => __( 'Teman', 'trav' ),
                                                            'user' => __( 'Sendiri', 'trav' ),
                                                        );
                                                    $active_trip_type = 0;
                                                    $i = 0;
                                        ...
                                        <div class="form-group col-md-5 no-float no-padding no-margin">
                                            <button type="submit" class="btn-large full-width submit-review"><?php echo __( 'KIRIM ULASAN', 'trav' ) ?></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="details">
                                ...
                                <?php if ( isset( $acc_meta['trav_accommodation_avg_price'] ) && is_numeric( $acc_meta['trav_accommodation_avg_price'][0] ) ) { ?>
                                    <span class="price clearfix">
                                        <small class="pull-left"><?php _e( 'Per Malam', 'trav' ); ?></small>
                                        <span class="pull-right"><?php echo esc_html( trav_get_price_field( $acc_meta['trav_accommodation_avg_price'][0] ) ); ?></span>
                                    </span>
                                <?php } ?>
                                <div class="feedback clearfix">
                                    <div title="<?php echo esc_attr( $acc_review . ' ' . __( 'Bintang', 'trav' ) );?>" class="five-stars-container" data-toggle="tooltip" data-placement="bottom"><span class="five-stars" style="width: <?php echo esc_attr( $acc_review / 5 * 100 );?>%;"></span></div>
                                    <span class="review pull-right"><?php echo esc_html( trav_get_review_count( $acc_id ) . ' ' . __( 'Ulasan', 'trav' ) ) ?></span>
                                </div>
                                <p class="description">
                                    <?php
                                ...
                                <?php if ( is_user_logged_in() ) {
                                    ...
                                    if ( ! in_array( trav_acc_org_id( $acc_id ), $wishlist) ) { ?>
                                        <a class="button yellow-bg full-width uppercase btn-small btn-add-wishlist" data-label-add="<?php _e( 'Tambah Daftar Keinginan', 'trav' ); ?>" data-label-remove="<?php _e( 'Hapus Daftar Keinginan', 'trav' ); ?>"><?php _e( 'Tambah Daftar Keinginan', 'trav' ); ?></a>
                                    <?php } else { ?>
                                        <a class="button yellow-bg full-width uppercase btn-small btn-remove-wishlist" data-label-add="<?php _e( 'Tambah Daftar Keinginan', 'trav' ); ?>" data-label-remove="<?php _e( 'Hapus Daftar Keinginan', 'trav' ); ?>"><?php _e( 'Hapus Daftar Keinginan', 'trav' ); ?></a>
                                    <?php } ?>
                                <?php } else { ?>
                                        <h5><?php _e( 'Untuk menyimpan, mohon login dahulu.', 'trav' ); ?></h5>
