                                ...
                                <?php if ( ! empty( $repeated ) ): ?>
                                    <form id="check_availability_form" method="post">
                                        ...
                                        <div class="update-search clearfix">
                                            <div class="alert alert-error" style="display:none;"><span class="message"><?php _e( 'Mohon Masukan tanggal Mulai .','trav' ); ?></span><span class="close"></span></div>
                                            <h4><?php _e( 'CEK KETERSEDIAAN TOUR', 'trav' ) ?></h4>
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-xs-6">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <button id="check_availability" data-animation-duration="1" data-animation-type="bounce" class="full-width animated bounce" style="background-color: #09477E" type="submit"><?php _e( "CEK TOUR", "trav" ); ?></button>
<!--                                                        icon-check-->
                                                    </div>
                                                </div>
                                            </div>
