                            ...
                            <div class="panel arrow-right">
                                ...
                                <div id="modify-search-panel" class="panel-collapse collapse in">
                                    <div class="panel-content">
                                        <form role="search" method="get" class="car-searchform"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="s" class="input-text full-width"
                                                       placeholder="<?php _e('Nama Kota, Bandara atau Daerah', 'trav') ?>"
                                                       value="<?php echo esc_attr($s); ?>"/>
                                            </div>
                                            <div class="search-when"
                                                 data-error-message1="<?php echo __('Tanggal Selesai Kamu sebelum tanggal Penjemputan. Mohon periksa lagi', 'trav') ?>"
                                                 data-error-message2="<?php echo __('Please select current or future dates for check-in and check-out.', 'trav') ?>">
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="datepicker-wrap from-today">
                                                        <input name="date_to" type="text" class="input-text full-width"
                                                               placeholder="<?php echo trav_get_date_format('html'); ?>"
                                            ...
                                            <br/>
                                            <button style="background-color: #09477E" class="btn-medium cari uppercase full-width"><?php _e('Cari Kendaraan', 'trav') ?></button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-8 col-md-9">
                        ...
                        <?php if (!empty($trav_options['ajax_pagination'])) { ?>
                            <?php if (count($results) >= $per_page) { ?>
                                <a href="<?php echo esc_url(add_query_arg(array('page' => ($page + 1)))); ?>"
                                   class="uppercase full-width button btn-large btn-load-more-accs"
                                   data-view="<?php echo esc_attr($current_view); ?>"
                                   data-search-params="<?php echo esc_attr(http_build_query($_GET, '', '&amp;')) ?>"><?php echo __('load more listing', 'trav') ?></a>
                            <?php } ?>
                        <?php } else {
                            unset($_GET['page']);
