...
?>
<h1 class="no-margin skin-color"><?php printf( __( 'Hallo Travelers', 'trav' ), $user_info['display_name'], get_bloginfo('name') ) ?></h1>
<br />
<div class="row block">
	<div class="col-md-6 notifications">
		<h2><?php printf( __( 'Penawaran Terbaru dari %s' ,'trav' ), get_bloginfo('name') ) ?></h2>
		<?php 
			$list_size = 8;
					...
					<a href="<?php the_permalink(); ?>">
						<div class="icon-box style1 fourty-space">
							<?php if ( $post_type == 'accommodation' ) { ?>
								...
								<span class="time pull-right"><?php echo human_time_diff( get_the_time('U'), current_time('timestamp') ) . esc_html__( ' yang lalu', 'trav' ); ?></span>
								<p class="box-title"><?php the_title(); ?>  <span class="price"><?php echo esc_html( trav_get_price_field( get_post_meta( $the_query->post->ID, 'trav_accommodation_avg_price', true ) ) ) ?></span></p>

							<?php } elseif ( $post_type == 'tour' ) { ?>

								<i class="soap-icon-beach blue-bg"></i>
								<span class="time pull-right"><?php echo human_time_diff( get_the_time('U'), current_time('timestamp') ) . esc_html__( ' yang lalu', 'trav' ); ?></span>
								<p class="box-title"><?php the_title(); ?>  <span class="price"><?php echo esc_html( trav_get_price_field( get_post_meta( $the_query->post->ID, 'trav_tour_min_price', true ) ) ) ?></span></p>

							<?php } elseif ( $post_type == 'car' ) { ?>

								<i class="soap-icon-car dark-blue-bg"></i>
								<span class="time pull-right"><?php echo human_time_diff( get_the_time('U'), current_time('timestamp') ) . esc_html__( ' yang lalu', 'trav' ); ?></span>
								<p class="box-title"><?php the_title(); ?>  <span class="price"><?php echo esc_html( trav_get_price_field( get_post_meta( $the_query->post->ID, 'trav_car_price', true ) ) ) ?></span></p>

							<?php } elseif ( $post_type == 'cruise' ) { ?>

								<i class="soap-icon-cruise red-bg"></i>
								<span class="time pull-right"><?php echo human_time_diff( get_the_time('U'), current_time('timestamp') ) . esc_html__( ' yang lalu', 'trav' ); ?></span>
								<p class="box-title"><?php the_title(); ?>  <span class="price"><?php echo esc_html( trav_get_price_field( get_post_meta( $the_query->post->ID, 'trav_cruise_avg_price', true ) ) ) ?></span></p>

							<?php } elseif ( $post_type == 'post' ) { ?>

								<i class="soap-icon-magazine blue-bg"></i>
								<span class="time pull-right"><?php echo human_time_diff( get_the_time('U'), current_time('timestamp') ) . esc_html__( ' yang lalu', 'trav' ); ?></span>
	...
	<div class="col-md-6">
		<h2><?php echo __( 'Aktivitas terakhir', 'trav' ) ?></h2>
					...
					if ( ! empty( $recent_activity ) ) {
						...
						foreach ( $recent_activity_array as $post_id ) {
							...
							if ( $post_type == 'accommodation' ) {
								...
								<li>
									<a href="<?php echo esc_url( get_permalink( $post_id ) ); ?>">
										...
										<span class="price blue-color"><small><?php _e( 'Per Malam', 'trav' ); ?></small><?php echo esc_html( trav_get_price_field( get_post_meta( $post_id, 'trav_accommodation_avg_price', true ) ) ); ?></span>
							...
							<?php } elseif ( $post_type == 'car' ) {
								...
								<li>
									<a href="<?php echo esc_url( get_permalink( $post_id ) ); ?>">
										<i class="icon soap-icon-car circle dark-blue-color"></i>
										<span class="price blue-color"><?php echo esc_html( trav_get_price_field( get_post_meta( $post_id, 'trav_car_price', true ) ) ); ?></span>
							...
							<?php } elseif ( $post_type == 'cruise' ) {
								...
								<li>
									<a href="<?php echo esc_url( get_permalink( $post_id ) ); ?>">
										<i class="icon soap-icon-cruise circle light-blue-color"></i>
