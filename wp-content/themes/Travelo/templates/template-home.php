...
*/
global $trav_options, $search_max_rooms, $search_max_adults, $search_max_kids, $search_max_passengers, $search_max_flighters, $def_currency;
					...
					<?php if ( count( $enabled_features ) > 1 ) : ?>
						<ul class="search-tabs clearfix">
							...
							<?php if ( in_array('tour', $enabled_features) ) : ?>
								<li <?php if ( $enabled_features[0] == 'tour' ) echo 'class="active"' ?> ><a href="#tours-tab" data-toggle="tab"><?php _e( 'TOUR', 'trav' ) ?></a></li>
							<?php endif; ?>
							<?php if ( in_array('car', $enabled_features) ) : ?>
								<li <?php if ( $enabled_features[0] == 'car' ) echo 'class="active"' ?> ><a href="#cars-tab" data-toggle="tab"><?php _e( 'BUS & MOBIL', 'trav' ) ?></a></li>
							<?php endif; ?>
							...
							<form role="search" method="get" class="acc-searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
								...
								<div class="row">
									<div class="form-group col-sm-6 col-md-3">
										...
										<input type="text" name="s" class="input-text full-width" placeholder="<?php _e( 'Masukan tujuan atau Nama Hotel', 'trav') ?>" />
									</div>
