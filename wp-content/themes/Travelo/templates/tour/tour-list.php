...
foreach( $tour_list as $tour ) {
    ...
    if ( $current_view == 'grid' ) { ?>
        ...
        <article class="box">
            <figure>
                <a title="<?php _e( 'Gallery', 'trav' ); ?>" class="hover-effect popup-gallery" data-post_id="<?php echo esc_attr( $tour_id );?>" href="#"><?php echo get_the_post_thumbnail( $tour_id, 'gallery-thumb' ); ?></a>
            ...
            <div class="details">
                ...
                <div class="action">
                    <a title="<?php _e( 'Lihat Rincian', 'trav' ); ?>" class="button btn-small full-width" href="<?php echo esc_url( $url ); ?>"><?php _e( 'PESAN', 'trav' ); ?></a>
                </div>
            </div>
        </article>
