        ...
        <div class="booking-details travelo-box">
            ...
            <article class="tour-detail">
                <figure class="clearfix">
                    ...
                    <div class="travel-title">
                        ...
                        <a href="<?php echo esc_url( $tour_url );?>" class="button red-color"><?php _e( 'UBAH', 'trav'); ?></a>
                    </div>
                </figure>
                <div class="details">
                    <div class="icon-box style12 style13 full-width">
                        <div class="icon-wrapper">
                            <i class="soap-icon-calendar blue-color"></i>
                        </div>
                        <dl class="details">
                            <dt class="skin-color"><?php _e( 'Waktu', 'trav' ) ?></dt>
                            <dd><?php echo date_i18n( "j M, Y", trav_strtotime( $booking_data['tour_date'] ) );?></dd>
                        </dl>
                    </div>
                    <div class="icon-box style12 style13 full-width">
                        <div class="icon-wrapper">
                        ...
                        <dl class="details">
                            <dt class="skin-color"><?php _e( 'Durasi', 'trav' ) ?></dt>
                            <dd><?php echo $price_data['duration'] ?></dd>
                        </dl>
                    </div>
                    <div class="icon-box style12 style13 full-width">
                        <div class="icon-wrapper">
                            <i class="soap-icon-departure blue-color"></i>
                        </div>
                        <dl class="details">
            ...
            <dl class="other-details">
                <?php if ( ! empty( $multi_book ) ) : ?>
                    <dt class="feature"><?php _e( 'Harga Per Orang', 'trav' ); ?>:</dt><dd class="value"><?php echo esc_html( trav_get_price_field( $price_data['price'] ) ) ?></dd>
                    <?php if ( ! empty( $price_data['child_price'] ) && ( (float) $price_data['child_price'] ) > 0 ) : ?>
                        <dt class="feature"><?php _e( 'Harga Per Anak', 'trav' ); ?>:</dt><dd class="value"><?php echo esc_html( trav_get_price_field( $price_data['child_price'] ) ) ?></dd>
                    <?php endif; ?>
                    <dt class="feature"><?php _e( 'Dewasa', 'trav' ); ?>:</dt><dd class="value"><?php echo esc_html( $booking_data['adults'] ) ?></dd>
                    <?php if ( ! empty( $booking_data['kids'] ) ) : ?>
                        <dt class="feature"><?php _e( 'Anak', 'trav' ); ?>:</dt><dd class="value"><?php echo esc_html( $booking_data['kids'] ) ?></dd>
                    <?php endif; ?>
                <?php endif; ?>
                ...
                <dt class="total-price"><?php _e( 'Total Harga', 'trav'); ?></dt><dd class="total-price-value blue-color"><?php echo esc_html( trav_get_price_field( $booking_data['total_price'] ) ) ?></dd>
            </dl>
            ...
            submitHandler: function( form ) {
                if ( tjq('input[name="agree"]').length ) {
                    if ( tjq('input[name="agree"]:checked').length == 0 ) {
                        alert("<?php echo esc_js( __( 'Setuju dan Tunduk pada syarat & ketentuan' ,'trav' ) ); ?>");
                        return false;
                    }
                }
