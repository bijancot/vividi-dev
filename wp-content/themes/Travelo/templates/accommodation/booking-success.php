...
<div class="row">
    <div class="col-sm-8 col-md-12">
        <div class="booking-information travelo-box">
            ...
            <div style="margin-left: auto; margin-right: auto">
                <div class="row">
                    <div class="col-sm-6 col-md-8" style="background-color: #cccccc">
                        <img src="https://vividi.id/wp-content/uploads/2019/10/new-logo.png" alt="" width="205"
                             height="45" style="margin-top: 10px;margin-bottom: 10px; margin-left: 5px"/>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-8" style="background-color: #e6e6e6">
                        ...
                        ?>
                        <!--                        <span style="font-family: arial; color: #023f75; font-size: 17px; margin-left: 20px; margin-bottom: 10px; display:inline-block;"><b>-->
                        <?php //echo ($a[0].", ".$b[0]." ".$b[1]." ".$b[2]." "); ?><!--</b>-->
                        <b><span style="font-family: arial; color: #023f75; font-size: 18px; margin-left: 20px; margin-top: 5px; margin-bottom: 10px; display:inline-block"
                                 id="demo"></span></b>
                        <!--                        </span>-->
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-8" style="background-color: #F5F4F4">
                        <img src="<?php echo($booking_data['bank']); ?>"
                             style="display: inline;width:72px; height:48px; margin-left: 20px; border-radius:5px; margin-top: 10px; margin-bottom: 10px "/>
                        <span id="copyTarget"
                              style="font-family: arial; margin-top: 20px;float: right; font-size: 18px; margin-right: 10px"><?php echo($booking_data['no_rekening']) ?> <img
                                    style="width: 20px; height: 20px"
                                    src="https://vividi.id/wp-content/themes/Travelo/images/copy.png" id="copyButton"/></span>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top: 10px;display: inline-block; margin-right: 18px">
                    <div class="col-sm-6 col-md-12" style="background-color: #F5F4F4;height:75px;">
                        ...
                        <img src="https://vividi.id/wp-content/themes/Travelo/images/telephone.jpg" alt=""
                             style="height: 25px; margin-left: 10px; margin-right:5px;margin-top: 10px; margin-bottom: 10px"/>
                        <a style="color: #023f75; text-decoration: none; display: inline-block; margin-top: 20px; margin-right: 20px;  float: right"
            ...
            <!--            <dl class="term-description">-->
            <!--                <dt>--><?php //echo __( 'Kamar', 'trav' ) ?><!--:</dt><dd>-->
            <?php //echo esc_html( trav_get_price_field( $booking_data['room_price'] * $booking_data['exchange_rate'], $booking_data['currency_code'], 0 ) ) ?><!--</dd>-->
            <!---->
            <!--                --><?php //if ( ! empty( $tax_rate ) ) : ?>
            <!--                    <dt>-->
            <?php //printf( __('Pajak (%d%%) Termasuk', 'trav' ), $tax_rate ) ?><!--:</dt><dd>-->
            <?php //echo esc_html( trav_get_price_field( $booking_data['tax'] * $booking_data['exchange_rate'], $booking_data['currency_code'], 0 ) ) ?><!--</dd>-->
            <!--                --><?php //endif; ?>
            <!---->
            <!--                --><?php //if ( ! empty( $booking_data['discount_rate'] ) ) : ?>
            <!--                    <dt>--><?php //echo __('Discount', 'trav' ) ?><!--:</dt><dd>-->
            <?php //echo '-' . $booking_data['discount_rate'] . '%' ?><!--</dd>-->
            <!--                --><?php //endif; ?>
            <!---->
            <!--                --><?php //if ( ! ( $booking_data['deposit_price'] == 0 ) ) : ?>
            <!--                    <dt>-->
            <?php //printf( __('Deposit (%d%%)', 'trav' ), $deposit_rate ) ?><!--:</dt><dd>-->
            <?php //echo esc_html( trav_get_price_field( $booking_data['deposit_price'], $booking_data['currency_code'], 0 ) ) ?><!--</dd>-->
            <!--                --><?php //endif; ?>
            <!--            </dl>-->
            <!--            -->
            <!--            <dl class="term-description" style="font-size: 16px;" >-->
            <!--                <dt style="text-transform: none;">-->
            <?php //echo __( 'Total Harga', 'trav' ) ?><!--</dt><dd><b style="color: #09477E;">-->
            <?php //echo esc_html( trav_get_price_field( $booking_data['total_price'] * $booking_data['exchange_rate'], $booking_data['currency_code'], 0 ) ) ?><!--</b></dd>-->
            <!--            </dl>-->
            <!--            <hr />-->
            <!---->
            ...
            <!--                <p>-->
            <?php //echo __( 'Kamu selalu dapat melihat atau mengubah pemesanan secara online - diperlukan pendaftaran', 'trav' ) ?><!--</p>-->
            ...
            <!--                        <li><a href="#change-date" class="soap-popupbox">-->
            <?php //echo __('Ubah Tanggal & Tamu','trav')?><!--</a></li>-->
            <!--                        <li><a href="#change-room" class="soap-popupbox">-->
            <?php //echo __('Ubah Kamar','trav')?><!--</a></li>-->
            <!--                    --><?php //} ?>
            <!--                    --><?php //if ( empty( $acc_meta["trav_accommodation_d_cancel_booking"] ) || empty( $acc_meta["trav_accommodation_d_cancel_booking"][0] ) ) { ?>
            <!--                        <li><a href="-->
            <?php //$query_args['pbsource'] = 'cancel_booking'; echo esc_url( add_query_arg( $query_args ,get_permalink( $acc_id ) ) );?><!--" class="btn-cancel-booking">-->
            <?php //echo __('Batalkan Pesanan Saya','trav')?><!--</a></li>-->
            <!--                    --><?php //} ?>
            <!--                </ul>-->
            <!---->
