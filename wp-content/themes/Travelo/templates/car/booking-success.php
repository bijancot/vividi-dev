	...
	<div class="col-sm-8 col-md-9">
		<div class="booking-information travelo-box">
			...
			<?php if ( ( isset( $_REQUEST['payment'] ) && ( $_REQUEST['payment'] == 'success' ) ) || ( isset( $_REQUEST['message'] ) && ( $_REQUEST['message'] == 1 ) ) ): ?>
				<h2><?php _e( 'KONFIRMASI PEMESANAN', 'trav' ); ?></h2>
				<hr />
				<div class="booking-confirmation clearfix">
					<i class="soap-icon-recommend icon circle"></i>
					<div class="message">
						<h4 class="main-message"><?php _e( 'Terima Kasih, Pesanan Kamu telah masuk kedalam sistem kami.', 'trav' ); ?></h4>
						<p><?php _e( 'Cek email Kamu segera dan ikuti panduan selanjutnya.', 'trav' ); ?></p>
					</div>
