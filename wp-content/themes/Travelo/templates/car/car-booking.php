	...
	<div class="sidebar col-sms-6 col-sm-4 col-md-3">
        ...
        <div class="booking-details travelo-box">
            ...
            <article class="car-detail">
                <figure class="clearfix">
                    ...
                    <div class="travel-title">
                        ...
                        <a href="<?php echo esc_url( $edit_url );?>" class="button"><?php _e( 'UBAH', 'trav'); ?></a>
                    </div>
                </figure>
                <div class="details">
                    <div class="icon-box style11 full-width">
                        ...
                        <dl class="details">
                            <dt class="skin-color"><?php _e( 'Pemakaian', 'trav'); ?></dt>
                            <dd><?php echo date( "j M, Y", trav_strtotime( $booking_data['date_from'] ) );?> <?php _e( '  Sampai  ', 'trav'); ?> <?php echo date( "j M, Y", trav_strtotime( $booking_data['date_to'] ) );?></dd>
                        </dl>
                    </div>
                    <div class="icon-box style11 full-width">
                        <div class="icon-wrapper">
                        ...
                        <dl class="details">
                            ...
                            <dd><?php echo $booking_data['time_from']; ?> <?php _e( '  Sampai  ', 'trav'); ?> <?php echo $booking_data['time_to']; ?></dd>
                        </dl>
                    </div>
                    <div class="icon-box style11 full-width">
                        <div class="icon-wrapper">
                        ...
                        <dl class="details">
                            <dt class="skin-color"><?php _e( 'Lokasi Antar/Jemput', 'trav'); ?></dt>
                            <dd><?php echo $booking_data['location_from']; ?> <?php _e( '  KE ', 'trav'); ?> <?php echo $booking_data['location_to']; ?></dd>
                        </dl>
                    </div>
                </div>
            </article>
            
            <h4><?php _e( 'RICIAN LAINNYA', 'trav'); ?></h4>
            <dl class="other-details">
                ...
                <?php } ?>
                <dt class="feature"><?php _e( 'Harga Per Hari:', 'trav'); ?></dt><dd class="value" style="color: #09477E"><?php echo esc_html( trav_get_price_field( $car_price_data['price_per_day'] ) ); ?></dd>
