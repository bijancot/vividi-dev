        ...
        <div id="main">
            <div class="row">
                                ...
                                <div class="panel-content">
                                    <form role="search" method="get" class="tour-searchform" action="<?php echo esc_url( get_post_type_archive_link( 'tour' ) ); ?>">
                                        ...
                                        <div class="form-group">
                                            <label><?php _e( 'Mau wisata kemana ?','trav' ); ?></label>
                                            <input type="text" name="s" class="input-text full-width" placeholder="<?php _e( 'Masukan tujuan atau lokasi wisata', 'trav') ?>" value="<?php echo esc_attr( $s ); ?>" />
                                        </div>
                                        <div class="search-when" data-error-message1="<?php echo __( 'Tanggal akhir kamu sebelum tanggal awal, mohon periksa kembali.' , 'trav') ?>" data-error-message2="<?php echo __( 'Silakan pilih tanggal saat ini atau di masa depan untuk dari dan ke tanggal.' , 'trav') ?>">
                                            <div class="form-group">
                                                <label><?php _e( 'Berangkat','trav' ); ?></label>
                                            ...
                                            <div class="form-group">
                                                <label><?php _e( 'Pulang','trav' ); ?></label>
                                                <div class="datepicker-wrap from-today">
                ...
                <div class="col-sm-8 col-md-9">
                    ...
                    <?php } else { ?>
                        <div class="travelo-box"><?php _e( 'Tidak ada paket wisata yang tersedia', 'trav' );?></div>
                    <?php } ?>
                </div>
            </div>
        </div>
