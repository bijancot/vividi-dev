		                                        ...
		                                        <table>
		                                            ...
		                                            <tbody>
		                                            	<?php if( is_array( $cruise_schedules ) && ! empty( $cruise_schedules[0]['itinerary'] ) ):
				                                                ...
				                                                <tr>
				                                                    <td data-title="<?php _e( 'Day', 'trav' ); ?>"><?php echo $values[0]; ?></td>
				                                                    <td data-title="<?php _e( 'Ports of Call', 'trav' ); ?>"><?php echo $values[1]; ?></td>
				                                                    <td data-title="<?php _e( 'Arrival', 'trav' ); ?>"><?php echo $values[2]; ?></td>
				                                                    <td data-title="<?php _e( 'Departure', 'trav' ); ?>"><?php echo $values[3]; ?></td>
				                                                </tr>
		                                                <?php  endforeach; ?>
		                                                <?php endif; ?>
		                                            </tbody>
