							...
							<div class="single-navigation block">
								<div class="row">
									...
									<?php if ( ! empty( $prev_post ) ): ?>
										<div class="col-xs-6"><a rel="prev" href="<?php echo esc_url( get_permalink( $prev_post->ID ) ); ?>" class="button btn-large prev full-width"><i class="soap-icon-longarrow-left"></i><span><?php _e( 'Pos Sebelumnya', 'trav' ) ?></span></a></div>
									<?php endif; ?>
									<?php $next_post = get_next_post(); ?>
									<?php if ( ! empty( $next_post ) ): ?>
										<div class="col-xs-6<?php if ( empty($prev_post) ) echo ' col-xs-offset-6'; ?>"><a rel="next" href="<?php echo esc_url( get_permalink( $next_post->ID ) ); ?>" class="button btn-large next full-width"><span><?php _e( 'Pos Selanjutnya', 'trav' ) ?></span><i class="soap-icon-longarrow-right"></i></a></div>
									<?php endif; ?>
								</div>
							</div>
							<h2><?php _e( 'Kamu mungkin juga menyukai ini', 'trav' ); ?></h2>
