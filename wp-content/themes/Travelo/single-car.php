                        ...
                        <div class="tab-container style1" id="car-main-content">
                            <ul class="tabs">
                                <?php if (!empty($gallery_imgs) && $show_gallery) { ?>
                                    <li><a data-toggle="tab" href="#photos-tab"><?php echo __('Gallery', 'trav') ?></a>
                                    </li>
                                <?php } ?>
                                <?php if ($show_calendar) { ?>
                                    <li><a data-toggle="tab"
                                           href="#calendar-tab"><?php echo __('Kalender', 'trav') ?></a></li>
                                <?php } ?>
                            </ul>
                                            ...
                                            <?php if (!empty($calendar_desc)) { ?>
                                                <div class="col-sm-8">
                                                    ...
                                                    <div class="calendar-legend">
                                                        ...
                                                        <label class="unavailable"><?php echo __('Habis', 'trav') ?></label>
                                ...
                                <div class="tab-pane fade in active" id="car-details">
                                    <div class="intro table-wrapper full-width hidden-table-sms">
                                        <div class="col-sm-4 table-cell features">
                                            ...
                                            <table>
                                                ...
                                                if (!empty ($car_agent)) {
                                                    echo sprintf($tr, __('Penyedia Layanan', 'trav'), esc_attr($car_agent[0]->name));
                                                }
                                                if (!empty ($car_type)) {
                                                    echo sprintf($tr, __('Tipe Kendaraan', 'trav'), esc_attr($car_type[0]->name));
                                                }
                                                echo sprintf($tr, __('Nama Kendaraan', 'trav'), esc_html(get_the_title()));
                                                if (!empty ($car_meta["trav_car_passenger"])) {
                                                    echo sprintf($tr, __('Penumpang', 'trav'), esc_html($car_meta["trav_car_passenger"][0]));
                                                }
                                                if (!empty ($car_meta["trav_car_baggage"])) {
                                                    echo sprintf($tr, __('Bagasi', 'trav'), esc_html($car_meta["trav_car_baggage"][0]));
                                                }
                                                if (!empty ($car_meta["trav_car_max_cars"]) && $car_meta["trav_car_max_cars"][0] > 0) {
                                                    echo sprintf($tr, __('Fasilitas', 'trav'), __('Terlampir'));
                                                } else {
                                                    echo sprintf($tr, __('Fasilitas', 'trav'), __('Tidak Tersedia'));
                                                }
                                                if (!empty ($car_meta["trav_car_tax_rate"])) {
                                                    echo sprintf($tr, __('Pajak', 'trav'), esc_html($car_meta["trav_car_tax_rate"][0] . "%"));
                                                }
                                                if (!empty ($car_meta["trav_car_security_deposit"])) {
                                                    echo sprintf($tr, __('Deposit', 'trav'), esc_html($car_meta["trav_car_security_deposit"][0] . '%'));
                                                }
                                                ?>
                                                <!--</dl>-->
                                            </table>
                                        ...
                                        <div class="col-sm-8 table-cell">
                                            <div class="detailed-features clearfix">
                                                <div class="col-md-6">
                                                    <h4 class="box-title">
                                                        <?php _e('Lokasi Penjemputan', 'trav'); ?>
                                                        <?php if (!empty($car_meta["trav_car_pick_up_phone"])) { ?>
                                                            <small><?php _e('Telepon:', 'trav'); ?><?php echo $car_meta["trav_car_pick_up_phone"][0]; ?></small>
                                                        <?php } ?>
                                                    </h4>
                                                    <div class="icon-box style11">
                                                        ...
                                                        <dl class="details">
                                                            <dt class="skin-color"><?php _e('Waktu Jemput', 'trav'); ?></dt>
                                                            <dd>
                                                                <?php
                                                                $time = array('anytime' => __('Setiap Saat', 'trav'), 'morning' => __('Mulai 04.00 WIB', 'trav'), 'afternoon' => __('Pukul 22.00', 'trav'));
                                                                ?>
                                                    ...
                                                    <div class="icon-box style11">
                                                        ...
                                                        <dl class="details">
                                                            <dt class="skin-color"><?php _e('Lokasi', 'trav'); ?></dt>
                                                            <dd>
                                                ...
                                                <div class="col-md-6">
                                                    <h4 class="box-title">
                                                        <?php _e('Lokasi Pengembalian', 'trav'); ?>
                                                        <?php if (!empty($car_meta["trav_car_drop_off_phone"])) { ?>
                                                            <small><?php _e('Telepon:', 'trav'); ?><?php echo $car_meta["trav_car_drop_off_phone"][0]; ?></small>
                                                        <?php } ?>
                                                    </h4>
                                                    <div class="icon-box style11">
                                                        <div class="icon-wrapper">
                                                        ...
                                                        <dl class="details">
                                                            <dt class="skin-color"><?php _e('Waktu Selesai', 'trav'); ?></dt>
                                    ...
                                    <form id="booking-form" method="post" action="">
                                        <div class="update-search clearfix">
                                            <div class="alert alert-error" style="display:none;"><span
                                                        class="message"><?php _e('Mohon masukan waktu Penggunaan.', 'trav'); ?></span><span
                                            ...
                                            <?php if (isset($_GET['edit_booking_no']) && !empty($_GET['edit_booking_no'])) : ?>
                                                <input type="hidden" name="edit_booking_no"
                                                       value="<?php echo esc_attr($_GET['edit_booking_no']) ?>">
                                                <input type="hidden" name="pin_code"
                                                       value="<?php echo esc_attr($_GET['pin_code']) ?>">
                                            <?php endif; ?>
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    ...
                                                    <div class="datepicker-wrap validation-field from-today">
                                                        <input name="date_from" type="text"
                                                               placeholder="<?php echo trav_get_date_format('html'); ?>"
                                                               class="input-text full-width"
                                                               value="<?php echo $date_from; ?>"/>
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <label><?php _e('WAKTU JEMPUT', 'trav'); ?></label>
                                                    <div class="timepicker-wrap validation-field">
                                                        <input name="time_from" type="text" placeholder=""
                                                               class="input-text full-width"
                                                               value="<?php echo $time_from; ?>"/>
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <label><?php _e('LOKASI JEMPUT', 'trav'); ?></label>
                                                    <div class="validation-field">
                                                        <input name="location_from" type="text" placeholder=""
                                                               class="input-text full-width"
                                                               value="<?php echo $location_from; ?>"/>
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <label><?php _e('JUMLAH KENDARAAN', 'trav'); ?></label>
                                                    <div class="validation-field">
                                                        <input name="total_car" type="number" placeholder="" value="1" min="1"
                                                               class="input-text full-width"
                                                               value="<?php echo $location_from; ?>"/>
                                                    </div>
                                                </div>
                                            ...
                                            <div calss="row">
                                                ...
                                                <div class="col-sm-3">
                                                    <label><?php _e('WAKTU SELESAI', 'trav'); ?></label>
                                                    <div class="timepicker-wrap validation-field">
                                                        <input name="time_to" type="text" placeholder=""
                                                               class="input-text full-width"
                                                               value="<?php echo $time_to; ?>"/>
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <label><?php _e('LOKASI PENGEMBALIAN', 'trav'); ?></label>
                                                    <div class="validation-field">
                                                        <input name="location_to" type="text" placeholder=""
                                                               class="input-text full-width"
                                                               value="<?php echo $location_to; ?>"/>
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <label><?php _e('TUJUAN', 'trav'); ?></label>
                                                    <div class="validation-field">
                                                        <input name="destination" type="text" placeholder=""
                                                               class="input-text full-width"
                                                               value="<?php echo $location_to; ?>"/>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-12">
                                                            <?php if (!is_user_logged_in()) { ?>
                                                                <a href="#travelo-login"
                                                                   class="button s full-width uppercase btn-small soap-popupbox"
                                                                   style="height: 34px"><?php _e('PESAN SEKARANG', 'trav'); ?></a>
                                                            <?php } else { ?>
                                                                <button style="background-color: #E35403"
                                                                        class="full-width animated bounce"
                                                                        type="submit"><?php _e("PESAN SEKARANG", "trav"); ?></button>
                                                            <?php } ?>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="sidebar col-md-3">
                        <article class="detailed-logo">
                            <?php if (isset($car_meta['trav_car_logo'])) { ?>
                                <figure>
                                    <img width="114"
                                         src="<?php echo esc_url(wp_get_attachment_url($car_meta['trav_car_logo'][0])); ?>"
                                         alt="Car Logo">
                                </figure>
                            <?php } ?>
                            ...
                            <div class="details">
                                ...
                                <?php if (isset($car_meta['trav_car_price']) && is_numeric($car_meta['trav_car_price'][0])) { ?>
                                    <span class="price clearfix">
	                                    ...
	                                    <span class="pull-right"
                                              style="color: #09477E"><?php echo esc_html(trav_get_price_field($car_meta['trav_car_price'][0])); ?></span>
	                                </span>
                                <?php } ?>
                                ...
                                <?php if (is_user_logged_in()) {
                                    ...
                                    if (!in_array(trav_car_org_id($car_id), $wishlist)) { ?>
                                        <a class="button yellow-bg full-width uppercase btn-small btn-add-wishlist"
                                           data-label-add="<?php _e('Tambah daftar keinginan', 'trav'); ?>"
                                           data-label-remove="<?php _e('Hapus daftar keinginan', 'trav'); ?>"><?php _e('Tambah daftar keinginan', 'trav'); ?></a>
                                    <?php } else { ?>
                                        <a class="button yellow-bg full-width uppercase btn-small btn-remove-wishlist"
                                           data-label-add="<?php _e('Tambah daftar keinginan', 'trav'); ?>"
                                           data-label-remove="<?php _e('Hapus daftar keinginan', 'trav'); ?>"><?php _e('Hapus daftar keinginan', 'trav'); ?></a>
                                    <?php } ?>
                                <?php } else { ?>
                                    <h5><?php _e('Login untuk menyimpan.', 'trav'); ?></h5>
                                    <a href="#travelo-login"
                                       class="button yellow-bg full-width uppercase btn-small soap-popupbox"><?php _e('login', 'trav'); ?></a>
                                <?php } ?>
