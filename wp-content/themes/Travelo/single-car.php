                                ...
                                <div class="tab-pane fade in active" id="car-details">
                                    ...
                                    <form id="booking-form" method="post" action="">
                                    	<div class="update-search clearfix">                                    	
                                    		<div class="alert alert-error" style="display:none;"><span class="message"><?php _e( 'Mohon masukan waktu Penggunaan.','trav' ); ?></span><span class="close"></span></div>
                            ...
                            <div class="details">
                                ...
                                <?php if ( isset( $car_meta['trav_car_price'] ) && is_numeric( $car_meta['trav_car_price'][0] ) ) { ?>
	                                <span class="price clearfix">
	                                    ...
	                                    <span class="pull-right" style="color: #09477E"><?php echo esc_html( trav_get_price_field( $car_meta['trav_car_price'][0] ) ); ?></span>
	                                </span>
                                <?php } ?>
