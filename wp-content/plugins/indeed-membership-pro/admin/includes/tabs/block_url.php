				...
				<div class="inside">
						...
						<div class="iump-form-line iump-special-line">
							...
							<div class="iump-form-line">
								...
								<select id="ihc-change-target-user-set" onChange="ihcWriteTagValue(this, '#ihc_block_url_entire-target_users', '#ihc_tags_field1', 'ihc_select_tag_' );" style="width: auto;">
				...
				<div class="ihc-stuffbox">
					...
					<div class="inside">
							...
							<div class="iump-form-line iump-special-line">
								...
								<div class="iump-form-line">
									<label class="iump-labels-special"><?php _e('Target Users:', 'ihc');?></label>
									<select id="ihc-change-target-user-set-regex" onChange="ihcWriteTagValue(this, '#ihc_block_url_word-target_users', '#ihc_tags_field2', 'ihc_select_tag_regex_' );" style="width: auto;">
										<option value="-1" selected>...</option>
										<?php
											foreach($posible_values as $k=>$v){
											?>
				...
				<div class="ihc-stuffbox">
					...
					<div class="inside">
						...
						<div class="iump-form-line iump-special-line">
							...
							<div class="iump-form-line">
								<label class="iump-labels-special"><?php _e('Target Users:', 'ihc');?></label>
								<select id="ihc-change-target-user-set-regex" onChange="ihcWriteTagValue(this, '#target_users', '#ihc_tags_field2', 'ihc_select_tag_regex_' );" style="width: auto;">
									<option value="-1" selected>...</option>
									<?php
										foreach($posible_values as $k=>$v){
										?>
