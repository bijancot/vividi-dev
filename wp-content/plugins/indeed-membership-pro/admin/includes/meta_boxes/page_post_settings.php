...
<div style="margin:4px 0;">
	...
	<label class="ihc-bold">...<?php _e('for', 'ihc');?></label>
		<?php
			...
			?>
			<select id="ihc-change-target-user-set" onChange="ihcWriteTagValueForEditPost(this, '#ihc_mb_who-hidden', '#ihc_tags_field', 'ihc_select_tag_' );" style="width: auto; min-width:80%;">
                        		...
                        		if (isset($posible_values[$value])){
                        			?>
		                        		<div id="ihc_select_tag_<?php echo $value;?>" class="ihc-tag-item">
		                        	    	...
		                        	    	<div class="ihc-remove-tag" onclick="ihcremoveTagForEditPost('<?php echo $value;?>', '#ihc_select_tag_', '#ihc_mb_who-hidden');" title="<?php _e('Removing tag', 'ihc');?>">x</div>
		                        	    </div>
		                        	<?php
                        		}
                        	}//end of foreach
