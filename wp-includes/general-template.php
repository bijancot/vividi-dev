...
function wp_logout_url( $redirect = '' ) {
	...
	$logout_url = add_query_arg( $args, site_url( 'member.php', 'login' ) );
...
function wp_login_url( $redirect = '', $force_reauth = false ) {
	$login_url = site_url( 'member.php', 'login' );
...
function wp_registration_url() {
	 ...
	 */
	return apply_filters( 'register_url', site_url( 'member.php?action=register', 'login' ) );
}
...
function wp_login_form( $args = array() ) {
	...
	$form = '
		<form name="' . $args['form_id'] . '" id="' . $args['form_id'] . '" action="' . esc_url( site_url( 'member.php', 'login_post' ) ) . '" method="post">
			' . $login_form_top . '
...
function wp_lostpassword_url( $redirect = '' ) {
	...
	$lostpassword_url = add_query_arg( $args, network_site_url( 'member.php', 'login' ) );
